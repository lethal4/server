...
public:
	...
	void setupUi(QDialog* ResetDialog)
	{
		...
		ResetDialog->setStyleSheet(QString::fromUtf8("background: transparent;"));
		...
		errTip->setMinimumSize(QSize(0, 25));
		errTip->setMaximumSize(QSize(16777215, 25));
		...
		user_lb->setMinimumSize(QSize(0, 40));
		user_lb->setMaximumSize(QSize(16777215, 40));
		...
		email_lb->setMinimumSize(QSize(48, 40));
		email_lb->setMaximumSize(QSize(48, 40));
		...
		varify_lb->setMinimumSize(QSize(0, 40));
		varify_lb->setMaximumSize(QSize(16777215, 40));
		...
		pwd_lb->setMinimumSize(QSize(0, 40));
		pwd_lb->setMaximumSize(QSize(16777215, 40));
		...
		pwd_edit->setMaximumSize(QSize(16777215, 30));
