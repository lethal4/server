...
struct qt_meta_stringdata_CLASSpictureBubbleENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSpictureBubbleENDCLASS = QtMocHelpers::stringData(
    "pictureBubble"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSpictureBubbleENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject pictureBubble::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSpictureBubbleENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSpictureBubbleENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSpictureBubbleENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<pictureBubble, std::true_type>
    >,
    nullptr
} };
...
void *pictureBubble::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSpictureBubbleENDCLASS.stringdata0))
